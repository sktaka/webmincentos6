...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/sktaka/webmincentos6/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/sktaka/webmincentos6/master/badvpn-udpgw64"
fi
